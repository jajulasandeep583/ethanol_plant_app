frappe.pages['m_distillation'].on_page_load = function(wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: 'M Distillation',
        single_column: true
    });

    // Initialize the page
    new EthanolPlantPage(page, 'm_distillation');
};
...
class EthanolPlantPage {
    ...
    init() {
        ...
        this.$wrapper.html(`
            <div class="ethanol-page-container" id="m_distillation-container">
                <div class="page-header">
                    <h2>M Distillation</h2>
