frappe.pages['d_evaporation'].on_page_load = function(wrapper) {
    ...
    // Initialize the page
    new EthanolPlantPage(page, 'd_evaporation');
};
...
class EthanolPlantPage {
    ...
    init() {
        ...
        this.$wrapper.html(`
            <div class="ethanol-page-container" id="d_evaporation-container">
