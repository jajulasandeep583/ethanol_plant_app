frappe.pages['d_distillation'].on_page_load = function(wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: 'D Distillation',
        single_column: true
    });

    // Initialize the page
    new EthanolPlantPage(page, 'd_distillation');
};
...
class EthanolPlantPage {
    ...
    init() {
        ...
        this.$wrapper.html(`
            <div class="ethanol-page-container" id="d_distillation-container">
                <div class="page-header">
                    <h2>D Distillation</h2>
