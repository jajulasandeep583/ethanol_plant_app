frappe.pages['fermentation_withoutlab'].on_page_load = function(wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: 'Fermentation Without Lab',
        single_column: true
    });

    // Initialize the page
    new EthanolPlantPage(page, 'fermentation_withoutlab');
};
...
class EthanolPlantPage {
    ...
    init() {
        ...
        this.$wrapper.html(`
            <div class="ethanol-page-container" id="fermentation_withoutlab-container">
                <div class="page-header">
                    <h2>Fermentation Without Lab</h2>
